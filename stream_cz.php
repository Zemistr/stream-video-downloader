...
@file_get_contents('http://piwik.zdft.net/piwik.php?idsite=7&rec=1&url=' . $url . '&action_name=' . rawurlencode($data['title']) . '&cip=' . @$_SERVER['REMOTE_ADDR'] . '&token_auth=13a8deb4bf6f0bbec63240301c0142c0');
